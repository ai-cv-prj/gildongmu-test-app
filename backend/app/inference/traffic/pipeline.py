"""
file_path: backend/app/inference/traffic/pipeline.py
...
from .geometry import estimate_stripe_direction
from .motion import estimate_camera_motion, motion_gray, transform_box
from .tracker import RECOVERY_CONFIDENCE, SignalTracker
