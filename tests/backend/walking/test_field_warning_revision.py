"""
file_path: tests/backend/walking/test_field_warning_revision.py
...
from backend.app.inference.walking.risk.surface_risk import SurfaceRisk
from backend.app.inference.walking.risk.hazard_labels import LabelMemory
from backend.app.inference.walking.risk.warning_summary import WarningSelector
from .test_risk import FRAME, detection, engine

CFG = yaml.safe_load((Path(__file__).resolve().parents[3] /
                     "config/walking_risk.yaml").read_text())["risk"]
