"""
file_path: tests/backend/walking/test_risk_shared_profile.py
...
from backend.app.inference.walking.risk.roi_recalibration import DirectionCalibration
...
from backend.app.inference.walking.risk.warning_groups import group_warnings
from .test_risk import detection,engine,FRAME

ROOT=Path(__file__).resolve().parents[3]
CFG=yaml.safe_load((ROOT/"config/walking_risk.yaml").read_text())["risk"]
