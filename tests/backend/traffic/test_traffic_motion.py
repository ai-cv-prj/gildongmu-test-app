"""
file_path: tests/backend/traffic/test_traffic_motion.py
...
from backend.app.inference.traffic.motion import estimate_camera_motion, motion_gray, transform_box
